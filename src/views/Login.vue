                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" method="POST" action="">
                            <div>
                                ...
                                <input type="text" name="loginname" id="loginname" class="bg-white border border-gray-500 text-gray-900 rounded sm:text-sm block w-full p-2.5 focus:outline-none" placeholder="name" required="">
                            </div>
                            <div>
                                <label for="loginpassword" class="block mb-2 text-sm font-medium text-gray-900">Password</label>
                                <input type="password" name="loginpassword" id="loginpassword" placeholder="••••••••" class="bg-white border border-gray-500 text-gray-900 rounded sm:text-sm block w-full p-2.5 focus:outline-none" required="">
                            </div>
